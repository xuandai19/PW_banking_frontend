...
=======
				if (bindingPackageVersion !== "1.85.0" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw Error(`Native binding package version mismatch, expected 1.85.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
>>>>>>> feature/v3_user_forgot
				return binding;
			} catch (e) {
				loadErrors.push(e);
...
=======
					if (bindingPackageVersion !== "1.85.0") throw Error(`WASI binding package version mismatch, expected 1.85.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
>>>>>>> feature/v3_user_forgot
				}
