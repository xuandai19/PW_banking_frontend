...
<<<<<<< HEAD
=======
interface NoUnmodifiedLoopCondition {
  /**
...
=======
export declare function defineConfig<T extends OxlintConfig>(config: T & OxlintConfig): T;
//#endregion
export type { AllowWarnDeny, DummyRule, DummyRuleMap, ExternalPluginEntry, ExternalPluginsConfig, OxlintConfig, OxlintEnv, OxlintGlobals, OxlintOverride, RuleCategories };
>>>>>>> feature/v3_user_forgot
